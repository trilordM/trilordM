...
<?php echo $this->Form->create('JobApplier'); ?>
	<fieldset>
		<legend><?php echo __('Edit Job Applier'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('JobApplier.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('JobApplier.id'))); ?></li>
