...
<h2><?php echo __('Job Applier'); ?></h2>
	<dl>
		...
		<dd>
			...
			&nbsp;
             <?php if(file_exists(WWW_ROOT.'job_applier_cv/'.$jobApplier['JobApplier']['your_cv'])&&!empty($jobApplier['JobApplier']['your_cv'])){ 
			 echo $this->Html->image('/job_applier_cv/'.$jobApplier['JobApplier']['your_cv'],array('width'=>140,'height'=>'100','alt'=>'Documents'));
			};?>
		</dd>
