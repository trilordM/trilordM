...
<?php echo $this->Form->create('ServiceRequestRelay'); ?>
	<fieldset>
		<legend><?php echo __('Edit Service Request Relay'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ServiceRequestRelay.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ServiceRequestRelay.id'))); ?></li>
