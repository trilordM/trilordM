...
<?php echo $this->Form->create('RatePackage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Rate Package'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RatePackage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('RatePackage.id'))); ?></li>
