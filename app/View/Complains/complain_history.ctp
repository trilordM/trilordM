<div class="main-page-title"><!-- start main page title -->
	<div class="container">
		<div class="page-title">Complain History</div>
	</div>
	...
	<div class="container">
		...
		<table cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
			...
			<tr>
				...
				echo $this->SmartForm->getUserInfo($history['Complain']['service_provider_id']);
				?>&nbsp;</td>
				<td><?php echo substr($history['Complain']['description'],'0','50').'...'; ?>&nbsp;</td>
