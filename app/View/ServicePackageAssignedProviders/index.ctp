<div class="servicePackageAssignedProviders index">
	...
	<tr>
		...
		<td><?php echo h($servicePackageAssignedProvider['ServicePackageAssignedProvider']['provider_id']); ?>&nbsp;</td>
		<td><?php echo h($servicePackageAssignedProvider['ServicePackageAssignedProvider']['assigned_date']); ?>&nbsp;</td>
