<div class="register-container"><!-- start .register-container -->
            <div class="title-container"><!-- start main page title -->
                <div class="container">
                    <div class="page-title">Service Seeker > Register</div>
                </div>
				...
				<div class="row">
					<div class="col-md-9 col-md-12 col-register-form">
						<?php echo $this->Form->create('User', array('novalidate' => true,'type'=>'file','role'=>'form', 'class'=>'contact')); ?>
                        	...
                        	<p class="col-md-12 info">Please note, fields marked with (*) are mandatory!</p>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
								<?php echo $this->Form->input('email',array('div' => array(
                                                                                    'class' => 'input text required'
                                                                                ),'id'=>'email','type'=>'text','class'=>'form-control email required','placeholder'=>'Email','tabindex'=>'2'));?>
								</div>
