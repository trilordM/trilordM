...
<?php echo $this->Form->create('User', array('novalidate' => true,'type'=>'file')); ?>
	<fieldset>
		<legend><?php //debug($user['User']['id']);die; 
	...
	<?php  	            
		...
		//debug($user['User']['profile_photo']);die;
		echo $this->Form->hidden('profile_photo',array('value'=>$user['User']['profile_photo']));
		echo $this->Form->input('id');
		echo $this->Form->input('company_name',array('id'=>'company_name','class'=>'default','label'=>'Company Name'));
