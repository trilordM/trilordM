            ...
            <div class="col-md-5">
                ...
                <?php echo $this->Form->create('User', array('novalidate' => true,'type'=>'file','role'=>'form')); ?>
                        <div class="form-group">
                         <?php echo $this->Form->input('email',array('id'=>'email','type'=>'text','class'=>'form-control input-form','label'=>false,'placeholder'=>"Email registered with  $company_name"));?>
                        </div>
                        <div class="form-group">
