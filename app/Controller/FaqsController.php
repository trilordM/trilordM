...
class FaqsController extends AppController
{
    ...
    public function admin_add($type = null)
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Faq->save($this->request->data)) {
                ...
                $this->Session->setFlash('The faq could not be saved. Please, try again.', 'default',
    ...
    public function admin_edit($type = null, $id = null)
    {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->Faq->save($this->request->data)) {
                ...
                $this->Session->setFlash('The faq could not be updated. Please, try again.', 'default',
                    array('class' => 'error-message'));
            }
        } else {
            $options = array('conditions' => array('Faq.' . $this->Faq->primaryKey => $id));
    ...
    public function admin_delete($type = null, $id = null)
    {
        ...
        if ($this->Faq->delete()) {
            ...
            $this->Session->setFlash('The faq could not be deleted. Please, try again.', 'default',
                array('class' => 'error-message'));
        }
