...
class RatePackagesController extends AppController
{
    ...
    public function add()
    {
        if ($this->request->is('post')) {
            ...
            if ($this->RatePackage->save($this->request->data)) {
                ...
                $this->Session->setFlash('The rate package could not be saved. Please, try again.', 'default',
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->RatePackage->save($this->request->data)) {
                ...
                $this->Session->setFlash('The rate package could not be updated. Please, try again.', 'default',
                    array('class' => 'error-message'));
            }
        } else {
            $options = array('conditions' => array('RatePackage.' . $this->RatePackage->primaryKey => $id));
    ...
    public function delete($id = null)
    {
        ...
        if ($this->RatePackage->delete()) {
            ...
            $this->Session->setFlash('The rate package could not be deleted. Please, try again.', 'default',
                array('class' => 'error-message'));
        }
