	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->ServicePackageAssignedProvider->save($this->request->data)) {
				$this->Session->setFlash('The service package assigned provider has been saved.','default',array('class'=>'success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('The service package assigned provider could not be saved. Please, try again.','default',array('class'=>'error-message'));
			}
		}
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->ServicePackageAssignedProvider->save($this->request->data)) {
				$this->Session->setFlash('The service package assigned provider has been updated.','default',array('class'=>'success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('The service package assigned provider could not be updated. Please, try again.','default',array('class'=>'error-message'));
			}
		} else {
			$options = array('conditions' => array('ServicePackageAssignedProvider.' . $this->ServicePackageAssignedProvider->primaryKey => $id));
 ...
 */
	public function delete($id = null) {
		...
		if ($this->ServicePackageAssignedProvider->delete()) {
			$this->Session->setFlash('The service package assigned provider has been deleted.','default',array('class'=>'success'));
		} else {
			$this->Session->setFlash('The service package assigned provider could not be deleted. Please, try again.','default',array('class'=>'error-message'));
		}
		return $this->redirect(array('action' => 'index'));
	}
