...
class UsdRatesController extends AppController
{
    ...
    public function admin_add()
    {
        if ($this->request->is('post')) {
            ...
            if ($this->UsdRate->save($this->request->data)) {
                ...
                $this->Session->setFlash('The usd rate could not be saved. Please, try again.', 'default',
    ...
    public function admin_edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->UsdRate->save($this->request->data)) {
                ...
                $this->Session->setFlash('The usd rate could not be updated. Please, try again.', 'default',
                    array('class' => 'error-message'));
            }
        } else {
            $options = array('conditions' => array('UsdRate.' . $this->UsdRate->primaryKey => $id));
    ...
    public function admin_delete($id = null)
    {
        ...
        if ($this->UsdRate->delete()) {
            ...
            $this->Session->setFlash('The usd rate could not be deleted. Please, try again.', 'default',
                array('class' => 'error-message'));
        }
