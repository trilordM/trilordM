	...
	public function admin_edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->PaypalSetting->save($this->request->data)) {
				...
				$this->Session->setFlash('The paypal setting could not be saved. Please, try again.','default',array('class'=>'error-message'));
			}
		} else {
			$options = array('conditions' => array('PaypalSetting.' . $this->PaypalSetting->primaryKey => $id));
	...
	public function admin_sms($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			...
			if ($this->PaypalSetting->save($this->request->data)) {
				...
				$this->Session->setFlash('The SMS setting could not be saved. Please, try again.','default',array('class'=>'error-message'));
			}
		} else {
			$options = array('conditions' => array('PaypalSetting.' . $this->PaypalSetting->primaryKey => $id));
			$this->request->data = $this->PaypalSetting->find('first', $options);
	...
	public function admin_esewa($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->PaypalSetting->save($this->request->data)) {
				...
				$this->Session->setFlash('The esewa setting could not be saved. Please, try again.','default',array('class'=>'error-message'));
			}
		} else {
			$options = array('conditions' => array('PaypalSetting.' . $this->PaypalSetting->primaryKey => $id));
			$this->request->data = $this->PaypalSetting->find('first', $options);
	...
	public function admin_moco($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->PaypalSetting->save($this->request->data)) {
				...
				$this->Session->setFlash('The moco setting could not be saved. Please, try again.','default',array('class'=>'error-message'));
			}
		} else {
			$options = array('conditions' => array('PaypalSetting.' . $this->PaypalSetting->primaryKey => $id));
			$this->request->data = $this->PaypalSetting->find('first', $options);
