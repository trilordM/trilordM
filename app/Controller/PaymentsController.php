    ...
    */
            ...
            if ($this->Payment->validates($this->request->data)) {
                ...
                try {
                    ...
                    if ($payment_return['ACK'] === 'Success') {
                        ...
                        $this->Session->setFlash('Total payment of ' . $this->request->data['Payment']['amount'] . ' USD has been made successfully.',
                ...
                $this->Session->setFlash('The request could not be completed at the moment. Please, try again.',
    ...
    public function bank_deposit()
    {
        if ($this->request->is('post')) {
            if ($this->Payment->validates($this->request->data)) {
                ...
                $this->Session->setFlash('Deposit Request has been sent for verification.', 'default',
                    array('class' => 'success'));
    ...
    public function esewa_deposit($q = null, $oid = null, $amt = null, $refId = null)
    {
        ...
        */
        if (isset($this->params->query['q']) && $this->params->query['q'] == 'fu') {
            $this->Session->setFlash('The request could not be completed at the moment. Please, try again.', 'default',
                array('class' => 'success'));
        }
        ...
        if (isset($this->params->query['q']) && $this->params->query['q'] == 'su') {
            ...
            $this->Payment->query('insert into service_seeker_deposits
									...
									');
            $this->Session->setFlash('Your payment has been successfully accounted. Thank You.', 'default',
                array('class' => 'success'));
    ...
    public function esewa_success()
    {
        ...
        if (isset($this->params->query['q']) && $this->params->query['q'] == 'su') {
            ...
            if (count($getEsewaTransactions) > 0) {
                ...
                $this->Session->setFlash('Your payment could not be verified. Please contact admin to verify your payment.',
                    'default', array('class' => 'error-message'));
    ...
    public function esewa_redirect()
    {
        ...
        if ($this->request->data['Payments']['amount'] == '') {
            $this->Session->setFlash('The payment could not be completed. Please, try again.', 'default',
                array('class' => 'error-message'));
