...
class ServiceCategoriesController extends AppController
{
    ...
    public function add()
    {
        if ($this->request->is('post')) {
            ...
            if ($this->ServiceCategory->save($this->request->data)) {
                $this->Session->setFlash('The service category has been saved.', 'default',
                    array('class' => 'success'));

                return $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash('The service category could not be saved. Please, try again.', 'default',
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->ServiceCategory->save($this->request->data)) {
                $this->Session->setFlash('The service category has been updated.', 'default',
                    array('class' => 'success'));

                return $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash('The service category could not be updated. Please, try again.', 'default',
                    array('class' => 'error-message'));
            }
        } else {
            $options = array('conditions' => array('ServiceCategory.' . $this->ServiceCategory->primaryKey => $id));
    ...
    public function delete($id = null)
    {
        ...
        if ($this->ServiceCategory->delete()) {
            ...
            $this->Session->setFlash('The service category could not be deleted. Please, try again.', 'default',
                array('class' => 'error-message'));
        }
