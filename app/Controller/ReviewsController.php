...
class ReviewsController extends AppController
{
    ...
    public function add($id = null, $request_id = null)
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Review->save($this->request->data)) {
                ...
                $this->Session->setFlash('The review could not be saved. Please, try again.', 'default',
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->Review->save($this->request->data)) {
                ...
                $this->Session->setFlash('The review could not be updated. Please, try again.', 'default',
                    array('class' => 'error-message'));
            }
        } else {
            $options = array('conditions' => array('Review.' . $this->Review->primaryKey => $id));
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Review->delete()) {
            ...
            $this->Session->setFlash('The review could not be deleted. Please, try again.', 'default',
                array('class' => 'error-message'));
        }
