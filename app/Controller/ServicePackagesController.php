	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->ServicePackage->save($this->request->data)) {
				...
				$this->Session->setFlash('The service package could not be saved. Please, try again.','default',array('class'=>'error-message'));
			}
		}
	}
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->ServicePackage->save($this->request->data)) {
				$this->Session->setFlash('The service package has been updated.','default',array('class'=>'success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('The service package could not be updated. Please, try again.','default',array('class'=>'error-message'));
			}
		} else {
			$options = array('conditions' => array('ServicePackage.' . $this->ServicePackage->primaryKey => $id));
 ...
 */
	public function delete($id = null) {
		...
		if ($this->ServicePackage->delete()) {
			...
			$this->Session->setFlash('The service package could not be deleted. Please, try again.','default',array('class'=>'error-message'));
		}
		return $this->redirect(array('action' => 'index'));
	}
